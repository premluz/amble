...
/// change was lg" (confirmed final values: sm 20/12, md 24/14, lg 28/16 —
/// see `AmbleTheme.sizeTaskBadgeSm`/`textTaskTitleSm` and its md/lg
/// siblings for the exact pairing).
///
