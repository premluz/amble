...
/// mutation, and [ZoneList]'s call `scheduleForZone`/`cancelForZone`; tests
/// that aren't specifically about notification behavior should override
/// `notificationServiceProvider` with this instead.
